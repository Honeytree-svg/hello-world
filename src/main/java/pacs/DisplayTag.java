...
public final class DisplayTag {
     ...
     * @param valueNoun : "dot" mettre la main.java.date en format yyyy.mm.dd ou dd.mm.yyyy sinon en format yyyy mm dd ou dd mm yyyy/ "dot" put yyyy.mm.dd or dd.mm.dd or dd.mm.yyyy else yyyy mm or dd mm yyyy
     ...
     * @param valueNoun : "dot" mettre la main.java.date en format yyyy.mm.dd ou dd.mm.yyyy sinon en format yyyy mm dd ou dd mm yyyy/dot" put yyyy.mm.dd or dd.mm.dd or dd.mm.yyyy else yyyy mm or dd mm yyyy
     * @return afficher le string du tag selon le standard international/ return string main.java.date
     * @throws IOException
     */
    ...
    /**
     * Format tag
     * @param Numero : String main.java.date
     * @param valueBool : if true Format yyyy.mm.dd else format dd.mm.yyyy
     * @param valueNoun : "dot" put the main.java.date in format yyyy.mm.dd or dd.mm.yyyy else in format yyyy mm dd or dd mm yyyy
     * @return
     */
