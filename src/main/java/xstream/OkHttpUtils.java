...
public class OkHttpUtils {
    ...
    public OkHttpUtils addParam(Map<String, String> p) {
        if (paramMap == null) {
            paramMap = new LinkedHashMap<>(16);
        }
        paramMap.putAll(p);
    ...
    public OkHttpUtils addRequestBody(String requestBody) {

        this.requestBody = requestBody;
        return this;
    }

    public OkHttpUtils methonName(String methonName) {
    ...
    public OkHttpUtils post(boolean isJsonPost) {
        ...
        if (isJsonPost) {
            ...
            requestBody = RequestBody.create(MediaType.parse("application/x-www-form-urlencoded;charset=UTF-8"),this.requestBody);
        }
        request = new Request.Builder().post(requestBody).url(url);
        return this;
    }

    public OkHttpUtils post(String inputXml) {
        String requestBody = "MethonName=" + methonName + "&" + "InputXml=" + inputXml;
