...
import main.java.xstream.msg.H;
import main.java.xstream.msg.Root;
import main.java.xstream.msg.SMS;
...
//                .post(false);
        ...
        OkHttpUtils post2 = OkHttpUtils.builder().url("http://222.138.30.213:83/KD_INTERFACE_V3.asmx")
                .addParam("service","extend_inter.kd_interface_v3.appointment_getdeptinfo")
                .addRequestBody("<req>\n" +
